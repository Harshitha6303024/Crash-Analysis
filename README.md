...
A Linux kernel debugging project that reproduces crashes in a disposable VM, captures the resulting vmcore with kdump, and analyzes it using crash or drgn.
